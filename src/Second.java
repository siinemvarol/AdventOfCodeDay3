...
public class Second {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < inputString.length(); i++) {
            ...
            if (inputString.charAt(i) == 'd' && inputString.charAt(i + 1) == 'o' && inputString.charAt(i + 2) == 'n'
                    && inputString.charAt(i + 3) == '\'' && inputString.charAt(i + 4) == 't'
                    && inputString.charAt(i + 5) == '(' && inputString.charAt(i + 6) == ')') {
//                System.out.println("don't starts at char... " + i);
                execute = false;
            }
            if (inputString.charAt(i) == 'd' && inputString.charAt(i + 1) == 'o' && inputString.charAt(i + 2) == '('
                    && inputString.charAt(i + 3) == ')') {
//                System.out.println("do starts at char... " + i);
                execute = true;

            }

            if (execute) {
                if (inputString.charAt(i) == 'm' && inputString.charAt(i + 1) == 'u' && inputString.charAt(i + 2) == 'l'
                        && inputString.charAt(i + 3) == '(') {
                    int indexOfComma = 0;
